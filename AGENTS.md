# Agent Instructions for distraction-filters
...
## Filter List Header & Versioning

`social.txt` begins with a uBO/AdGuard metadata header (`! Title:`, `! Version:`,
...
1. Creates a new issue titled "🧪 Test filters: YYYY-MM-DD"
